...
vsa::SpectrumAnalyzerCurve::SpectrumAnalyzerCurve(int fftSize)
...
void vsa::SpectrumAnalyzerCurve::pushCurve(std::span<const float> fftCurve)
{
...
void vsa::SpectrumAnalyzerCurve::setSampleRate(double sampleRate)
{
...
float vsa::SpectrumAnalyzerCurve::indexToX(const double index) const
{
...
float vsa::SpectrumAnalyzerCurve::binToY(float bin)
{
...
void vsa::SpectrumAnalyzerCurve::generateCurve()
{
    std::lock_guard guard{ m_lock };
...
vsa::SpectrumAnalyzerCurve::LockedCurve vsa::SpectrumAnalyzerCurve::getCurve()
{
    generateCurve();
